...
Esperta Aria is a single-user, localhost-only personal agent. Its security model is
...
1. **No filesystem sandboxing** -- exec commands can read/write any file the Esperta Aria
