...
Legacy compatibility packages such as `projects-engine`, `shared-types`, `providers-*`, and `connectors` still exist, but they now primarily preserve older import surfaces.
